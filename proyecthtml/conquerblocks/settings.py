...
SECRET_KEY = 'django-insecure-v55kq3!fmutwe#egi8*7cfm@wzg_l0+061fie5-gewid3w&l%p'
...
# and the EMAIL_USE_TLS and EMAIL_USE_SSL settings control whether a secure connection is used.ç

EMAIL_HOST='smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER='alexserr.dev@gmail.com'
EMAIL_HOST_PASSWORD = 'kdjv quqc crrm ilet'
EMAIL_USE_TLS = True


LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/' #la vista a la que se redirige despues de un login exitoso
LOGIN_REDIRECT_URL = '' #la vista a lka que se redirige despues de un logout